...
## Tests
```text
      at TestContext.<anonymous> (/home/runner/work/novel-reader/novel-reader/src/lib/admin-access.test.ts:32:10)
    ...
    code: 'ERR_ASSERTION',
    actual: 'unknown',
    expected: '2001:db8::12',
    operator: 'strictEqual',
    diff: 'simple'
  }

test at src/lib/content-access.test.ts:2:2433
✖ matches structured content access rules by audience and scope (441.600294ms)
  AssertionError [ERR_ASSERTION]: Expected values to be strictly equal:
  
  true !== false
  
      at TestContext.<anonymous> (/home/runner/work/novel-reader/novel-reader/src/lib/content-access.test.ts:76:10)
      at Test.runInAsyncScope (node:async_hooks:227:14)
      at Test.run (node:internal/test_runner/test:1397:25)
...
test at src/lib/content-access.test.ts:2:5845
✖ supports whole-site country allowlists without affecting the admin bypass (234.123531ms)
  AssertionError [ERR_ASSERTION]: Expected values to be strictly equal:
  
  false !== true
  
      at TestContext.<anonymous> (/home/runner/work/novel-reader/novel-reader/src/lib/content-access.test.ts:123:10)
      at Test.runInAsyncScope (node:async_hooks:227:14)
      at Test.run (node:internal/test_runner/test:1397:25)
      at Test.processPendingSubtests (node:internal/test_runner/test:969:18)
      at Test.postRun (node:internal/test_runner/test:1537:19)
...
test at src/lib/content-access.test.ts:2:6850
✖ creates a temporary rule after a configured access policy is exceeded (205.881789ms)
  AssertionError [ERR_ASSERTION]: Expected values to be strictly equal:
...
✖ migrates supported application data and discards retired access records (528.661259ms)
  AssertionError [ERR_ASSERTION]: Expected values to be strictly equal:
...
✖ original articles derive access from price and transfer paid unlocks exactly once (233.370465ms)
...
✖ creates salted password hashes and verifies the original password (7.271993ms)
  AssertionError [ERR_ASSERTION]: Expected values to be strictly equal:
  + actual - expected
...
✖ rejects malformed or unreasonably cheap password hashes (0.595252ms)
  AssertionError [ERR_ASSERTION]: Expected values to be strictly equal:
  + actual - expected
...
✖ uses the full-text index for mixed encodings and safely includes changed books (385.431831ms)
  AssertionError [ERR_ASSERTION]: Expected values to be strictly deep-equal:
  + actual - expected
...
✖ merges ready library shards and isolates a removed shard (193.697407ms)
  AssertionError [ERR_ASSERTION]: Expected values to be strictly deep-equal:
  + actual - expected
