...
export type SiteSettings = {
  ...
  readerDefaultPageTurn: ReaderPageTurn;
...
export function normalizeSiteSettings(value: unknown): SiteSettings {
  ...
  return {
    ...
    readerDefaultPageTurn: normalizeReaderPageTurn(
      typeof parsed.readerDefaultPageTurn === "string" ? parsed.readerDefaultPageTurn : undefined,
      DEFAULT_SETTINGS.readerDefaultPageTurn,
    ),
    ...
    analyticsRealtimeLimit: cleanInt(parsed.analyticsRealtimeLimit, DEFAULT_SETTINGS.analyticsRealtimeLimit, 0, 100_000),
