...
import { deleteAdminTagAction, saveAdminTagAction } from "@/app/admin/actions";
import { AdminFrame } from "../AdminFrame";
import { database } from "@/core/db/postgres";
import { listPostgresCatalogTagGroups, type PostgresCatalogTag as Tag, type PostgresCatalogTagGroup as TagGroup } from "@/domains/catalog/postgres-tags";
...
export default async function AdminTagsPage({ searchParams }: AdminTagsPageProps) {
  ...
  const allGroups = await listPostgresCatalogTagGroups(database(), { audience: "admin" });
