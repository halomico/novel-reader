...
const TRADITIONAL_UI_TEXT: Readonly<Record<string, string>> = {
  ...
  "管理最近记录": "管理最近記錄",
  "选择": "選擇",
  "选择当前页全部草稿": "選擇目前頁面全部草稿",
  "选择当前页全部记录": "選擇目前頁面全部記錄",
  "选择当前页全部收藏": "選擇目前頁面全部收藏",
  "已读完": "已讀完",
  "阅读进度": "閱讀進度",
  "确认清空": "確認清空",
  "个人内容": "個人內容",
  ...
  "删除失败，请重试": "刪除失敗，請重試",
  "删除这篇草稿？": "刪除這篇草稿？",
  "删除后无法恢复，已发布文章不会受到影响。": "刪除後無法復原，已發佈文章不會受到影響。",
  "草稿已删除": "草稿已刪除",
  "删除中…": "刪除中…",
  "清空": "清空",
  "搜索": "搜尋",
  ...
  "搜索结果读取失败": "搜尋結果讀取失敗",
  "搜索失败": "搜尋失敗",
  "匹配内容较多，已按更新时间列出部分结果": "匹配內容較多，已按更新時間列出部分結果",
  "仅显示最近更新的": "僅顯示最近更新的",
  "条结果": "條結果",
  "匹配范围过大，请换用更具体的关键词": "匹配範圍過大，請換用更具體的關鍵詞",
  "搜索启动失败": "搜尋啟動失敗",
  "全文搜索任务已取消": "全文搜尋任務已取消",
  "搜索标签": "搜尋標籤",
  "清空搜索": "清空搜尋",
