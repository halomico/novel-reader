...
import { formatCompactUpdateDate, formatLocalDateTime, formatRelativeUpdateTime, toDateTimeAttribute } from "./date-time";
...
test("formats PostgreSQL ISO timestamps into a requested local timezone", () => {
  assert.equal(formatLocalDateTime("2026-07-08T10:00:00.000Z", { timeZone: "UTC" }), "2026/7/8 10:00:00");
  assert.equal(formatLocalDateTime("2026-07-08T10:00:00.000Z", { timeZone: "Asia/Shanghai" }), "2026/7/8 18:00:00");
});
