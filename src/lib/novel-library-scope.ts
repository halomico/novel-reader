...
export function novelLibraryDisplayName(source: { slug: string; name: string }): string {
  return source.slug.toLocaleLowerCase("en-US") === DEFAULT_NOVEL_LIBRARY_SLUG ? "默认" : source.name;
}
